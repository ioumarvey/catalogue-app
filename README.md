...
* User account (registration, editing account information, changing password, adding to favorites)
* Administrator (login, changing password, changing administrator information)
* Administrator with the ability to create, edit and delete content on the website
* CRUD for products
...
* Adding products to "Favorites" list only for registered users
